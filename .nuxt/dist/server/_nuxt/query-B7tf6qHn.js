...
import { a as useRequestEvent, u as useContentPreview } from "./preview-BlFyxuDY.js";
import "destr";
import "klona";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-BY1Ijslh.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-B7tf6qHn.js.map
