import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'file:///home/andix/andixblog/node_modules/vue/index.mjs';
import { d as useNuxtApp, e as asyncDataDefaults, f as createError, c as useRuntimeConfig } from './server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file:///home/andix/andixblog/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///home/andix/andixblog/node_modules/ohash/dist/index.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-BlFyxuDY.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BY1Ijslh.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-B7tf6qHn.mjs.map
